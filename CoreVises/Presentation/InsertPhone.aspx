                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="txtP" runat="server" ErrorMessage="You can only type numbers"
                                    ControlToValidate="txtPixels" ValidationExpression="^[0-9]{8}$" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                                <br />
                            </td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="txtPr" runat="server" ErrorMessage="You can only type numbers"
                                    ControlToValidate="txtPrice" ValidationExpression="^[0-9]{8}$" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                                <br />
                            </td>
                        </tr>
                         <tr>
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="txtQ" runat="server" ErrorMessage="You can only type numbers"
                                    ControlToValidate="txtQuantity" ValidationExpression="^[0-9]{8}$" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                                <br />
                            </td>
                        </tr>
                        <tr>
