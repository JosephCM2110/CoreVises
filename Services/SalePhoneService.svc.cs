...
namespace Services
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "SalePhoneService" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select SalePhoneService.svc or SalePhoneService.svc.cs at the Solution Explorer and start debugging.
    public class SalePhoneService : ISalePhoneService
    {
